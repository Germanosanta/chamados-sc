 ...
 * (useEquipUniverso, equivalente a _equipUniverso()). */
export function EquipAutocomplete({ onSelect, placeholder }: EquipAutocompleteProps) {
  ...
  return (
    <div className="relative">
      ...
      {results.length > 0 && (
        <div className="absolute z-50 mt-1 w-full max-h-72 overflow-auto rounded-sm border border-border bg-popover shadow-lg">
          {results.map((r, i) => (
            <button
              key={r.c}
              type="button"
